...
public class DBInterface {
    ...
    public void addPatient(JSONObject data){
        try {
            ...
            String message = "INSERT INTO patients (\"firstName\", \"lastName\", \"phonenumber\") values ('"+p.firstName+"', '"+p.lastName+"','"+p.phoneNum+"');";
            s.execute(message);

        }catch(JSONException f){
            System.out.println("Error while executing JSON command function");
        }catch(SQLException e){
            System.out.println("Error while executing SQL command function");
        }
    }
}
