...
// jan 2019 : adapted unit tests to new format (first/last name >> name)

/*
This unit testing code focuses on the DBinterface functions.
For each one we create a test input which has the same format as the string received from the Client
